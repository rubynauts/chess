...
RSpec.describe Rook do
  describe "#valid_move?" do
    context "given a Rook at [0,0]" do
      ...
      let(:piece) {ChessPiece.create(position_x: 4, position_y: 0, game: game)}
      it "will return false when trying to move to [0,6]" do
      ...
      it "will return true when trying to move to [6,0]" do
        piece
        expect(rook.valid_move?(6,0)).to be_truthy
      end
    end
  end
end